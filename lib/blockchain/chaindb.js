...
class ChainDB {
  ...
  async getSpentView(meta) {
    process.emitWarning(
      'deprecated, use node.require("indexer").getSpentView',
      'DeprecationWarning'
    );
    return null;
  }
  ...
  async getMeta(hash) {
    process.emitWarning(
      'deprecated, use node.require("indexer").getMeta',
      'DeprecationWarning'
    );
    return null;
  }
  ...
  async getTX(hash) {
    process.emitWarning(
      'deprecated, use node.require("indexer").getTX',
      'DeprecationWarning'
    );
    return null;
  }
  ...
  async hasTX(hash) {
    process.emitWarning(
      'deprecated, use node.require("indexer").hasTX',
      'DeprecationWarning'
    );
    return false;
  }
  ...
  async getMetaByAddress(addrs) {
    process.emitWarning(
      'deprecated, use node.require("indexer").getMetaByAddress',
      'DeprecationWarning'
    );
    return [];
  }
